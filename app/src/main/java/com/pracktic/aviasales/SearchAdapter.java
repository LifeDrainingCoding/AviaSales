...
public class SearchAdapter extends RecyclerView.Adapter<SearchAdapter.ViewHolder> {
    ...
    private onDissMissList dialogInterface;
    public SearchAdapter(ArrayList<AviaLine> aviaLines, OnCheckedListener callback, FragmentManager fragmentManager, onDissMissList dialogInterface) {
    ...
    @NotNull
    @Override
    public SearchAdapter.ViewHolder onCreateViewHolder(@NonNull @NotNull ViewGroup viewGroup, int i) {
...
//        v.lineNumber.setOnClickListener(v1 -> {
//            SelectClassFragment selectClassFragment = new SelectClassFragment(callback,dialogInterface);
//            callback.onChecked(aviaLine,i,true );
//            selectClassFragment.show(fragmentManager,"tag");
//
//        });
    }
    ...
    public static class ViewHolder extends RecyclerView.ViewHolder {
        ...
        public ViewHolder(@NonNull @NotNull View v) {
            super(v);
            layout = v.findViewById(R.id.layout_linear);
